...
def main():
    ...
    training_args = DPOConfig(
        output_dir="./qwen_dpo_output_total_naive_prompt",
    ...
    # 6. 모델 저장
    print("모델을 저장합니다...")
    dpo_trainer.save_model("./qwen_dpo_final_total_naive_prompt")
    tokenizer.save_pretrained("./qwen_dpo_final_total_naive_prompt")
