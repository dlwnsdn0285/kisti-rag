...
import argparse
#from <recomp_module> import <method> # when use recomp
#from <ext2gen_module> import <method> # when use ext2gen
...
def get_retrieval_chain(args, retriever, k, shuffle=False):
    ...
    # new_docs : wrapper function for recomp/ext2gen/base
    if args.generation == "recomp":
        new_docs = None # <recomp_module.method> # when use recomp
    elif args.generation == "ext2gen":
        new_docs = None # <ext2gen_module.method> # when use ext2gen
    else:
        new_docs = lambda x : x # use original docs, w/o recomp & ext2gen
